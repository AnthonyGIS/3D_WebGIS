...
var Windy = function Windy(params) {
	...
	var VELOCITY_SCALE = (params.velocityScale || 0.04) * (Math.pow(window.devicePixelRatio, 1 / 3) || 1); // scale for wind velocity (completely arbitrary--this value looks nice)
