...
var Ary_Marker = new Array();//标注对象数组
var Ary_MarkerUserd = new Array();//标记标注对象是否被使用（1表示被使用）
var Ary_PolyLine = new Array();//折线对象数组
var Ary_PolyLinecount = 100;//折线数组的最大值
var Ary_PolyLineUsed = new Array();//标记折线对象是否被使用（1表示被使用）
var Ary_PolyPoint = new Array();//折线点
