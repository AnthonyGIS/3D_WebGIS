 ...
 * (c) www.geocento.com, www.metaaps.com
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 * You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0
 *
 * modified by weng. v 2.1 2019.1.13 2148
 */

var Drawer_Helper_DemoUse = {};
Drawer_Helper_DemoUse.viewer = null;
Drawer_Helper_DemoUse.drawHelper = null;
Drawer_Helper_DemoUse.toolbar = null;
Drawer_Helper_DemoUse.initialDrawHelper = function (viewer, tool_bar, logging_panel) {

    this.viewer = viewer;
    if(document.getElementById(tool_bar)  == null) {
        var div_tool_bar = document.createElement("div"); //设置 div 属性，如 id
        div_tool_bar.setAttribute("id", tool_bar);
        //parent.appendChild(div_tool_bar);
        document.body.appendChild(div_tool_bar);
    }

    if(document.getElementById(logging_panel)  == null) {
        var div_logging_panel = document.createElement("div");
        div_logging_panel.setAttribute("id", logging_panel);
        document.body.appendChild(div_logging_panel);
    }

    var drawHelper = new DrawHelper(viewer);
    var toolbar = drawHelper.addToolbar(document.getElementById(tool_bar), {
    ...
    toolbar.addListener('markerCreated', function (event) {
        ...
        var billboard = b.add({
            ...
            pixelOffset: new Cesium.Cartesian2(0, -12*scale),
    ...
    var logging = document.getElementById(logging_panel);
