define(['./Container','./ThumbGroup','../models/LayerCollection','./LoadingProgress','iScroll','Cesium'],function(Container,ThumbGroup,LayerCollection,LoadingProgress,iScroll,Cesium){
    ...
    var WebServicePan = Container.extend({
        ...
        initialize : function(options){
            ...
            this.privateUrl = 'http://www.supermapol.com/web/mycontent/datas.jsonp?t=' + new Date().getTime() + "&currentPage=1&pageSize=10&orderBy=LASTMODIFIEDTIME&orderType=DESC";
            ...
            this.on('componentAdded',function(parent){
            	var url = "http://www.supermapol.com/web/services.json?enable=true&checkStatus=SUCCESSFUL&orderBy=UPDATETIME&orderType=DESC&types=[REALSPACE,MAP]&userNames=[399055,366379]&pageSize=18";
            		...
            		$('#webServicesWraper').scroll(function(){  
                        ...
                        if(height + scrollTop == scrollHeight){
                        	...
                        	if(selType == 'public'){
                            	...
                            	newUrl = "http://www.supermapol.com/web/services.json?enable=true&checkStatus=SUCCESSFUL&orderBy=UPDATETIME&orderType=DESC&types=[REALSPACE,MAP]&userNames=[399055,366379]&pageSize=18&currentPage=" + me.currentPublicPage;
                        		...
                        		newUrl = 'http://www.supermapol.com/web/services.json?offline=false&enable=true&checkStatus=SUCCESSFUL&orderBy=UPDATETIME&orderType=DESC&keywords=[' + window.USERNAME+ ']&filterFields=["RESTITLE","LINKPAGE","USERNAME"]&t=1480990924314&currentPage=' + me.currentPrivatePage;
        ...
        onSelChange : function(evt){
        	...
        	if(value === 'public'){
        		...
        		url = 'http://www.supermapol.com/web/services.json?currentPage=1&offline=false&enable=true&checkStatus=SUCCESSFUL&orderBy=UPDATETIME&orderType=DESC&keywords=[' + window.USERNAME+ ']&filterFields=["RESTITLE","LINKPAGE","USERNAME"]&t=1480990924314';
